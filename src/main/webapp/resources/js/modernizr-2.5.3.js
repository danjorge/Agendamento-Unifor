...
$("#small").click(function(event){
    ...
    $("label").animate({"font-size":"12px", "line-height":"16px"});	
    $("td").animate({"font-size":"12px", "line-height":"16px"});	
    $("textarea").animate({"font-size":"12px", "line-height":"16px"});	
    $("select").animate({"font-size":"12px", "line-height":"16px"});	
    $("input").animate({"font-size":"12px", "line-height":"16px"});
  ...
  $("#medium").click(function(event){
    ...
    $("label").animate({"font-size":"14px", "line-height":"20px"});	
    $("td").animate({"font-size":"14px", "line-height":"20px"});	
    $("textarea").animate({"font-size":"14px", "line-height":"20px"});	
    $("select").animate({"font-size":"14px", "line-height":"20px"});	
    $("input").animate({"font-size":"14px", "line-height":"20px"});
  ...
  $("#large").click(function(event){
    ...
    $("label").animate({"font-size":"16px", "line-height":"22px"});	
    $("td").animate({"font-size":"16px", "line-height":"22px"});	
    $("textarea").animate({"font-size":"16px", "line-height":"22px"});	
    $("select").animate({"font-size":"16px", "line-height":"22px"});	
    $("input").animate({"font-size":"16px", "line-height":"22px"});
...
function formatMoney(int) {
    ...
    //int = parseInt(int.toString().replace('.', '').replace(',', ''));
    var tmp;
...
$(document).ready(function () {
    ...
    if (getCookie('fullSize') != null && getCookie('fullSize') == 'true') {
        FullSize();
    } else {
        DefaultSize();
    }
...
function FullSize() {
    $('#header').attr('class', 'wrap');
    $('#header').attr('style', 'height:80px');
    $('#menu').removeClass('container');
    $('#body').removeClass('container');
    $('#migalha').removeClass('container');
    $('#migalha').attr('style', 'height:20px');
    $('#body').css('margin', '10px');
    $('#changescreen-fatmenu-item').removeClass('glyphicon-resize-full');
    $('#changescreen-fatmenu-item').addClass('glyphicon-resize-small');
    setCookie('fullSize', 'true', 10);
}

function DefaultSize() {
    $('#header').attr('class', 'container');
    $('#header').attr('style', '');
    $('#menu').addClass('container');
    $('#body').addClass('container');
    $('#migalha').addClass('container');
    $('#body').css('margin', '');
    $('#changescreen-fatmenu-item').removeClass('glyphicon-resize-small');
    $('#changescreen-fatmenu-item').addClass('glyphicon-resize-full');
    setCookie('fullSize', 'false', 10);
}
...
//ALTERAÇÕES ANDRÉ STAMATTO
//----------------------------------------------------------
function setDialogFocus(inputId){
	setTimeout(function() {
		$('body').children().find(inputId).focus();
	});
}
//----------------------------------------------------------